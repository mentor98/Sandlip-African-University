...
export const hostels = [
  { name: "Daniel Hall (Male)", type: "Ensuite Quad", fee: "₦120,000", available: 14 },
  { name: "Joseph Hall (Male)", type: "Standard Quad", fee: "₦95,000", available: 22 },
  { name: "Lydia Hall (Female)", type: "Ensuite Quad", fee: "₦120,000", available: 8 },
  { name: "Dorcas Hall (Female)", type: "Standard Quad", fee: "₦95,000", available: 18 }
];
